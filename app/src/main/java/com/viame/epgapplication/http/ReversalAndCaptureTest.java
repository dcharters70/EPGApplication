...
public class ReversalAndCaptureTest
{
 public static final void main(String[] aArgs){
	...
	try {
		...
		transaction.setProperty("TransactionHint", "RVS:Y");
		
		// The following is must be replaced with the TransactionID of a previously
		// authorized transaction
		transaction.setProperty("TransactionID","116370944561");
		...
		System.out.println("Balance : "+transaction.getProperty("Balance"));
